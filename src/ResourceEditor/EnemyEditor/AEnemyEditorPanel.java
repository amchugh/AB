...
public class AEnemyEditorPanel extends JPanel {
    ...
    public AEnemyEditorPanel(AResourceManager<ABPSpecies> speciesManager, AResourceManager<ABPAction> actionManager) {
        super();
